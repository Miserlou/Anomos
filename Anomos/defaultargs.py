...
common_options = [
    ...
    ('identity', '', 'the identity to use (basename of pub/pvt key)')
    ]
...
rare_options = [
    ...
    ('anonymizer', 'https://tracker.anomos.info:5555/announce',
...
def get_defaults(ui):
    ...
    if ui == 'makeatorrentgui':
        r.extend([
            ...
            ('tracker_name', 'https://tracker.anomos.info:5555/announce',
